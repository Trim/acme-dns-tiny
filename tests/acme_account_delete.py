import subprocess, os, json, base64, binascii, re, copy, logging, urllib
...
def delete_account(accountkeypath, log=LOGGER):
    ...
    def _send_signed_request(url, payload):
        ...
        protected["nonce"] = urllib.urlopen(ACMEDirectory).headers["Replay-Nonce"]
    ...
    directory = urllib.urlopen(ACMEDirectory)
